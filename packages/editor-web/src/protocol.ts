...
export type HostMessage = {
  ...
  type: 'loadDocument' | 'setDocumentType' | 'requestSnapshot' | 'command' | 'applyStyles' | 'localizeFindBar' | 'unsafeEmphasisResponse' | 'restoreViewport' | 'markSaved' | 'refreshOutline' | 'setCodeFormatterSettings' | 'codeFormatResult'
  requestId?: string
  documentId: string
  revision: number
  payload?: unknown
...
export function isHostMessage(value: unknown): value is HostMessage {
  ...
  return message.protocolVersion === protocolVersion
    ...
    || message.type === 'restoreViewport'
      ...
      || message.type === 'codeFormatResult'
      || message.type === 'setCodeFormatterSettings')
